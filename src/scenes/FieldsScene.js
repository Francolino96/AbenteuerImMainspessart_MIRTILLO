class FieldsScene extends Phaser.Scene {
    ...
    create() {
        ...
        let bgSource = this.textures.get('fields_background').getSourceImage();
    ...
    die() { 
        ...
        this.time.delayedCall(1000, () => {
            ...
            this.time.delayedCall(800, () => {
                this.scene.start('GameOverScene', { callingScene: 'FieldScene' });
            });
        });
    }
    ...
    win() { 
        ...
        this.time.delayedCall (1000, () => {
            ...
            this.time.delayedCall(1000, () => {
                this.cameras.main.fadeOut(800, 0, 0, 0);
                this.time.delayedCall(800, () => {
                    this.scene.start('Victory2Scene', { callingScene: 'FieldScene' });
                });
            });
        })
    }
