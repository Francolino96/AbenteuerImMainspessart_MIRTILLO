class OrchardScene extends Phaser.Scene {
    ...
    create() {
        ...
        const bgSource = this.textures.get('orchard_background').getSourceImage();
        ...
        // cinghiale 
        this.boar = this.physics.add.sprite(500*this.personalScale, this.mapHeight - boxWidth-5, 'boar').setOrigin(0.5,1); 
        this.boar.setScale(this.personalScale * 1.2).refreshBody();
        this.boar.setCollideWorldBounds(false);
        ...
        this.boar.setVelocityX(300 * this.personalScale);  
    ...
    die() { 
        ...
        this.time.delayedCall(1000, () => {
            ...
            this.time.delayedCall(800, () => {
                this.scene.start('GameOverScene', { callingScene: 'OrchardScene' });
            });
        });
    }
    ...
    win() { 
        ...
        this.time.delayedCall (1000, () => {
            ...
            this.time.delayedCall(1000, () => {
                this.cameras.main.fadeOut(800, 0, 0, 0);
                this.time.delayedCall(800, () => {
                    this.scene.start('Victory2Scene', { callingScene: 'OrchardScene' });
                });
            });
        })
    }
