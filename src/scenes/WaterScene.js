class WaterScene extends Phaser.Scene {
    ...
    create() {
        ...
        const bgSource = this.textures.get('water_background').getSourceImage();
    ...
    die() { 
        ...
        this.time.delayedCall(1000, () => {
            ...
            this.time.delayedCall(800, () => {
                this.scene.start('GameOverScene', { callingScene: 'WaterScene' });
            });
        });
    }
    ...
    win() { 
        ...
        this.time.delayedCall (1000, () => {
            ...
            this.time.delayedCall(1000, () => {
                this.cameras.main.fadeOut(800, 0, 0, 0);
                this.time.delayedCall(800, () => {
                    this.scene.start('Victory2Scene', { callingScene: 'WaterScene' });
                });
            });
        })
    }
